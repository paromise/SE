...
public class LicenseManagerTest {
    ...
    public void testGetRequiredLicenses11() {
        System.out.println("getRequiredLicenses Test10->Typical Rules");
        Integer declID = 1;
        LicenseManager instance = new LicenseManager();
        instance.setDeclarationDAO(new DeclarationDAOStub(){
            public Declaration findDeclarationById(int id){
...
//        expResult.add("Varedate Faravarde Nafti");
    ...
    @org.junit.Test
    public void testGetRequiredLicenses30() {
        System.out.println("getRequiredLicenses Test30->totalVal Bishtar az Had");
        Integer declID = 1;
        LicenseManager instance = new LicenseManager();
        instance.setDeclarationDAO(new DeclarationDAOStub(){
            public Declaration findDeclarationById(int id){
        ...
        instance.setRuleDAO(new RuleDAOStub(){
            public List<Rule> listRules() {
                ArrayList<Rule> rules = new ArrayList<Rule>();
                rules.add(new Rule("Felezi",50,10,100,1000,"Tedad","","","",1000));
                rules.add(new  Rule("Felezi",-1,-1,-1,-1,"Tedad","","","",-1));
        ...
        instance.setProductDAO(new ProductDAOStub(){
            public ArrayList<Product> findProductsByDeclId(Integer declId){
                ArrayList<Product> prods=new ArrayList<Product>();
                DeclManager declMng=new DeclManager();
                prods.add(new Product("Ahan","company1",60,"Tedad",20,1,"Felezi"));
...
//    @org.junit.Test
//    public void testGetRequiredLicenses32() {
//        System.out.println("getRequiredLicenses Test32->totalVal Manfi");
//        Integer declID = 1;
//        LicenseManager instance = new LicenseManager();
//        instance.setDeclarationDAO(new DeclarationDAOStub());
//        instance.setRuleDAO(new RuleDAOStub(){
...
//                ArrayList<Product> prods=new ArrayList<Product>();
//               
//                prods.add(new Product("Ahan","company1",60,"تعداد",20,1,"Felezi"));
//                
//                return prods;
//            }
//        });
...
//    }
     ...
     */
    @Test
    public void testSub_from_license() {
        System.out.println("sub_from_license");
        int licNum = 1;
        int declID = 1;
